...
WebUI.setText(findTestObject('Object Repository/Page_Mile.app  Login/input_Email or Username_email or username'), 'handychriastian@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Mile.app  Login/input_Password_password'), 'GbQbK8CgepVr7ZE7VBejJQ==')
